	...
	<form action="" id="manage-laundry" method="post">
		<div class="col-lg-12">	
				...
				<div class="col-md-6">
					<div class="form-group">
							...
							<select name="washing" id="" class="custom-select browser-default">
								...
								?>
								<option selected disabled hidden><?php echo $list2['washing_id'];?></option>
								<?php 
			...
			<div class="row">	
				...
				<div class="col-md-4">	
					<div class="form-group">	
						<label for="" class="control-label">Weight/Piece</label>
				...
				<table class="table table-bordered" id="list">
					...
					<thead>	
						<tr>
							...
							<th class="text-center">Weight(kg)/Piece(pc)</th>
